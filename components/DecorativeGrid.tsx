export function DecorativeGrid({labels}: {labels: string[]}) {
  ...
  return (
    <div className="relative min-h-[390px] overflow-hidden rounded-[1.5rem] border border-ink/10 bg-white shadow-soft">
      ...
      <div className="relative grid min-h-[390px] grid-rows-[auto_1fr_auto] p-8">
